...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        # For all sites, create a pie chart showing the total successes and failures
        ...
        fig = px.pie(filtered_site_df,
                     names='class',  # Column 'class' has 0 (failure) and 1 (success)
...
def get_scatter_chart(selected_site, payload_range):
    filtered_df = spacex_df
    # Obtener los límites de la carga útil seleccionada
    min_payload, max_payload = payload_range


    # Filtrar por carga útil
    ...
    if selected_site == 'ALL':
        fig = px.scatter(
            ...
            title='Payload Mass vs Success and Failure for All Sites',
        ...
        fig = px.scatter(
            ...
            y='class',
            color='Booster Version Category',
            title=f'Payload Mass vs Success and Failure for site {selected_site}',
            labels={'class': 'Launch Outcome'}
        )
